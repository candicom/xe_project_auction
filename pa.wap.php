<?php
     ...
     * @brief  pa module WAP class
     **/

    class paWAP extends pa {
        ...
        function procWAP(&$oMobile) {
            ...
            if($document_srl) {
                ...
                if($oDocument->isExists()) {
                    ...
                    if($this->act=='dispPaContentCommentList') {
                    ...
                    // display the document if the act is not display the comment list
                        ...
                        $content = Context::getLang('replies').' : <a href="'.getUrl('act','dispPaContentCommentList').'">'.$oDocument->getCommentCount().'</a><br>'."\r\n".$content;
